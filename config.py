...
# Read from env so credentials are never hard-coded.
# Set DATABASE_URL in your shell or a .env file before starting the server.
# Example: postgresql://postgres:secret@localhost:5432/testdb
